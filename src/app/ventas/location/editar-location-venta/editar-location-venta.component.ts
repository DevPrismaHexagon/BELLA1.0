...
@Component({
  selector: 'app-editar-location-venta',
  templateUrl: './editar-location-venta.component.html',
  styleUrls: ['./editar-location-venta.component.css']
})
export class EditarLocationVentaComponent implements OnInit {
